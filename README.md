...
пройти ревью ментора, дать доступ пользователям `KaymeKaydex` (Максим Коновалов), `svetlanasadovnikova` (Светлана Беляева), `K1ola` (Екатерина Кириллова), `TonyBlock` (Антон Чумаков) и `zorinarsenij` (Арсений Зорин) и кинуть на проверку
преподавателю.
