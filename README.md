...
пройти ревью ментора, дать доступ и кинуть на проверку одному из пользователей: `KaymeKaydex` (Максим Коновалов), `svetlanasadovnikova` (Светлана Беляева), `K1ola` (Екатерина Кириллова), `TonyBlock` (Антон Чумаков) и `zorinarsenij` (Арсений Зорин). Лучше писать преподавателю в лс, что ментор выдал вам аппрув, прикрепив ссылку на ПР.
